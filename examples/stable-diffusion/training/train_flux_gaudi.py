...
def main(args):
    ...
    deepspeed_config='./deepspeed_flux_config.json'
    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            with accelerator.accumulate(transformer):
                ...
                model_input = _pack_latents(model_input, bsz, num_channels_latents, height, width)
                ...
                #print(f'baymax transformer dtype:{transformer.dtype}')
                ...
                #print('baymax debug now to run forwad')
                ...
                #print('baymax debug run forwad done')
                #exit(0)
